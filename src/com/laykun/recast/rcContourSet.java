...
public class rcContourSet {
  ...
  protected rcContourSet(long cPtr, boolean cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = cPtr;
  }

  protected static long getCPtr(rcContourSet obj) {
  ...
  public void setConts(rcContour value) {
    RecastJNI.rcContourSet_conts_set(swigCPtr, this, rcContour.getCPtr(value), value);
  }

  public rcContour getConts() {
    long cPtr = RecastJNI.rcContourSet_conts_get(swigCPtr, this);
    return (cPtr == 0) ? null : new rcContour(cPtr, false);
  }
