...
public class dtNavMeshQuery {
  ...
  public SWIGTYPE_p_dtStatus init(dtNavMesh nav, int maxNodes) {
    return new SWIGTYPE_p_dtStatus(RecastJNI.dtNavMeshQuery_init(swigCPtr, this, dtNavMesh.getCPtr(nav), nav, maxNodes), true);
  }
  ...
  public SWIGTYPE_p_dtStatus findPath(long startRef, long endRef, SWIGTYPE_p_float startPos, SWIGTYPE_p_float endPos, dtQueryFilter filter, SWIGTYPE_p_unsigned_int path, SWIGTYPE_p_int pathCount, int maxPath) {
    return new SWIGTYPE_p_dtStatus(RecastJNI.dtNavMeshQuery_findPath(swigCPtr, this, startRef, endRef, SWIGTYPE_p_float.getCPtr(startPos), SWIGTYPE_p_float.getCPtr(endPos), dtQueryFilter.getCPtr(filter), filter, SWIGTYPE_p_unsigned_int.getCPtr(path), SWIGTYPE_p_int.getCPtr(pathCount), maxPath), true);
  }
  ...
  public SWIGTYPE_p_dtStatus initSlicedFindPath(long startRef, long endRef, SWIGTYPE_p_float startPos, SWIGTYPE_p_float endPos, dtQueryFilter filter, long options) {
    return new SWIGTYPE_p_dtStatus(RecastJNI.dtNavMeshQuery_initSlicedFindPath__SWIG_0(swigCPtr, this, startRef, endRef, SWIGTYPE_p_float.getCPtr(startPos), SWIGTYPE_p_float.getCPtr(endPos), dtQueryFilter.getCPtr(filter), filter, options), true);
  }
  ...
  public SWIGTYPE_p_dtStatus initSlicedFindPath(long startRef, long endRef, SWIGTYPE_p_float startPos, SWIGTYPE_p_float endPos, dtQueryFilter filter) {
    return new SWIGTYPE_p_dtStatus(RecastJNI.dtNavMeshQuery_initSlicedFindPath__SWIG_1(swigCPtr, this, startRef, endRef, SWIGTYPE_p_float.getCPtr(startPos), SWIGTYPE_p_float.getCPtr(endPos), dtQueryFilter.getCPtr(filter), filter), true);
  }

  public SWIGTYPE_p_dtStatus updateSlicedFindPath(int maxIter, SWIGTYPE_p_int doneIters) {
    return new SWIGTYPE_p_dtStatus(RecastJNI.dtNavMeshQuery_updateSlicedFindPath(swigCPtr, this, maxIter, SWIGTYPE_p_int.getCPtr(doneIters)), true);
  }

  public SWIGTYPE_p_dtStatus finalizeSlicedFindPath(SWIGTYPE_p_unsigned_int path, SWIGTYPE_p_int pathCount, int maxPath) {
    return new SWIGTYPE_p_dtStatus(RecastJNI.dtNavMeshQuery_finalizeSlicedFindPath(swigCPtr, this, SWIGTYPE_p_unsigned_int.getCPtr(path), SWIGTYPE_p_int.getCPtr(pathCount), maxPath), true);
  }
  ...
  public SWIGTYPE_p_dtStatus finalizeSlicedFindPathPartial(SWIGTYPE_p_unsigned_int existing, int existingSize, SWIGTYPE_p_unsigned_int path, SWIGTYPE_p_int pathCount, int maxPath) {
    return new SWIGTYPE_p_dtStatus(RecastJNI.dtNavMeshQuery_finalizeSlicedFindPathPartial(swigCPtr, this, SWIGTYPE_p_unsigned_int.getCPtr(existing), existingSize, SWIGTYPE_p_unsigned_int.getCPtr(path), SWIGTYPE_p_int.getCPtr(pathCount), maxPath), true);
  }
  ...
  public SWIGTYPE_p_dtStatus findNearestPoly(SWIGTYPE_p_float center, SWIGTYPE_p_float extents, dtQueryFilter filter, SWIGTYPE_p_unsigned_int nearestRef, SWIGTYPE_p_float nearestPt) {
    return new SWIGTYPE_p_dtStatus(RecastJNI.dtNavMeshQuery_findNearestPoly(swigCPtr, this, SWIGTYPE_p_float.getCPtr(center), SWIGTYPE_p_float.getCPtr(extents), dtQueryFilter.getCPtr(filter), filter, SWIGTYPE_p_unsigned_int.getCPtr(nearestRef), SWIGTYPE_p_float.getCPtr(nearestPt)), true);
  }
  ...
  public SWIGTYPE_p_dtStatus queryPolygons(SWIGTYPE_p_float center, SWIGTYPE_p_float extents, dtQueryFilter filter, SWIGTYPE_p_unsigned_int polys, SWIGTYPE_p_int polyCount, int maxPolys) {
    return new SWIGTYPE_p_dtStatus(RecastJNI.dtNavMeshQuery_queryPolygons(swigCPtr, this, SWIGTYPE_p_float.getCPtr(center), SWIGTYPE_p_float.getCPtr(extents), dtQueryFilter.getCPtr(filter), filter, SWIGTYPE_p_unsigned_int.getCPtr(polys), SWIGTYPE_p_int.getCPtr(polyCount), maxPolys), true);
  }
  ...
  public SWIGTYPE_p_dtStatus raycast(long startRef, SWIGTYPE_p_float startPos, SWIGTYPE_p_float endPos, dtQueryFilter filter, long options, dtRaycastHit hit, long prevRef) {
    return new SWIGTYPE_p_dtStatus(RecastJNI.dtNavMeshQuery_raycast__SWIG_1(swigCPtr, this, startRef, SWIGTYPE_p_float.getCPtr(startPos), SWIGTYPE_p_float.getCPtr(endPos), dtQueryFilter.getCPtr(filter), filter, options, dtRaycastHit.getCPtr(hit), hit, prevRef), true);
  }
  ...
  public SWIGTYPE_p_dtStatus raycast(long startRef, SWIGTYPE_p_float startPos, SWIGTYPE_p_float endPos, dtQueryFilter filter, long options, dtRaycastHit hit) {
    return new SWIGTYPE_p_dtStatus(RecastJNI.dtNavMeshQuery_raycast__SWIG_2(swigCPtr, this, startRef, SWIGTYPE_p_float.getCPtr(startPos), SWIGTYPE_p_float.getCPtr(endPos), dtQueryFilter.getCPtr(filter), filter, options, dtRaycastHit.getCPtr(hit), hit), true);
  }
  ...
  public SWIGTYPE_p_dtStatus findDistanceToWall(long startRef, SWIGTYPE_p_float centerPos, float maxRadius, dtQueryFilter filter, SWIGTYPE_p_float hitDist, SWIGTYPE_p_float hitPos, SWIGTYPE_p_float hitNormal) {
    return new SWIGTYPE_p_dtStatus(RecastJNI.dtNavMeshQuery_findDistanceToWall(swigCPtr, this, startRef, SWIGTYPE_p_float.getCPtr(centerPos), maxRadius, dtQueryFilter.getCPtr(filter), filter, SWIGTYPE_p_float.getCPtr(hitDist), SWIGTYPE_p_float.getCPtr(hitPos), SWIGTYPE_p_float.getCPtr(hitNormal)), true);
  }
  ...
  public SWIGTYPE_p_dtStatus getPolyWallSegments(long ref, dtQueryFilter filter, SWIGTYPE_p_float segmentVerts, SWIGTYPE_p_unsigned_int segmentRefs, SWIGTYPE_p_int segmentCount, int maxSegments) {
    return new SWIGTYPE_p_dtStatus(RecastJNI.dtNavMeshQuery_getPolyWallSegments(swigCPtr, this, ref, dtQueryFilter.getCPtr(filter), filter, SWIGTYPE_p_float.getCPtr(segmentVerts), SWIGTYPE_p_unsigned_int.getCPtr(segmentRefs), SWIGTYPE_p_int.getCPtr(segmentCount), maxSegments), true);
  }
  ...
  public SWIGTYPE_p_dtStatus findRandomPoint(dtQueryFilter filter, SWIGTYPE_p_f___float frand, SWIGTYPE_p_unsigned_int randomRef, SWIGTYPE_p_float randomPt) {
    return new SWIGTYPE_p_dtStatus(RecastJNI.dtNavMeshQuery_findRandomPoint(swigCPtr, this, dtQueryFilter.getCPtr(filter), filter, SWIGTYPE_p_f___float.getCPtr(frand), SWIGTYPE_p_unsigned_int.getCPtr(randomRef), SWIGTYPE_p_float.getCPtr(randomPt)), true);
  }
  ...
  public SWIGTYPE_p_dtStatus closestPointOnPoly(long ref, SWIGTYPE_p_float pos, SWIGTYPE_p_float closest, SWIGTYPE_p_bool posOverPoly) {
    return new SWIGTYPE_p_dtStatus(RecastJNI.dtNavMeshQuery_closestPointOnPoly(swigCPtr, this, ref, SWIGTYPE_p_float.getCPtr(pos), SWIGTYPE_p_float.getCPtr(closest), SWIGTYPE_p_bool.getCPtr(posOverPoly)), true);
  }

  public SWIGTYPE_p_dtStatus closestPointOnPolyBoundary(long ref, SWIGTYPE_p_float pos, SWIGTYPE_p_float closest) {
    return new SWIGTYPE_p_dtStatus(RecastJNI.dtNavMeshQuery_closestPointOnPolyBoundary(swigCPtr, this, ref, SWIGTYPE_p_float.getCPtr(pos), SWIGTYPE_p_float.getCPtr(closest)), true);
  }

  public SWIGTYPE_p_dtStatus getPolyHeight(long ref, SWIGTYPE_p_float pos, SWIGTYPE_p_float height) {
    return new SWIGTYPE_p_dtStatus(RecastJNI.dtNavMeshQuery_getPolyHeight(swigCPtr, this, ref, SWIGTYPE_p_float.getCPtr(pos), SWIGTYPE_p_float.getCPtr(height)), true);
  }
